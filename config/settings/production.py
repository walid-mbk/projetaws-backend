...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["caustaza.com"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Caustaza Backend Project <noreply@caustaza.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[Caustaza Backend Project]",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa: F405
    {"url": "https://caustaza.com", "description": "Production server"},
]
# Your stuff...
# ------------------------------------------------------------------------------
